...
int main() {
    ...
    analyzer_py = LexicalAnalyzer('python')
    tokens_py = analyzer_py.tokenize(python_code)
    for token in tokens_py:
        print(token)
    
    print("\n=== JAVA TOKENIZATION ===")
    analyzer_java = LexicalAnalyzer('java')
    tokens_java = analyzer_java.tokenize(java_code)
    for token in tokens_java:
        print(token)
    
    print("\n=== C++ TOKENIZATION ===")
    analyzer_cpp = LexicalAnalyzer('cpp')
    tokens_cpp = analyzer_cpp.tokenize(cpp_code)
    for token in tokens_cpp:
        print(token)
